 ...
 * 
 * Esta clase configura la documentación automática de la API utilizando
 * la especificación OpenAPI 3.0 (anteriormente conocida como Swagger).
 * 
 * La documentación resultante estará disponible en: /api/swagger-ui.html
 * 
 * @author Tutorial
 * @version 1.0
 */
...
public class SwaggerConfig {
    ...
    public OpenAPI catalogServiceOpenAPI() {
        return new OpenAPI()
                ...
                .servers(List.of(
                        new Server().url(contextPath).description("Servidor por defecto")
                ))
